...
public:
    ...
    static double** read_file_array(FILE *MF,int maxsize=255,int nskiprows=0, int nskiprcols=0, int (*oncalcrows)(int) = 0, int (*oncalccols)(int) = 0, int (*onelementset)(int,int,double) = 0);

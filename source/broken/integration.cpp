...
int CIntegration::doCalc()
{
	...
	App::rayIntegration = App::rayToObj;
	printf("rayToObj: (%le;%le)\n", App::rayIntegration.angle.y, App::rayIntegration.angle.z);
	printf("from: (%le;%le;%le)\n", App::rayIntegration.start.x, App::rayIntegration.start.y, App::rayIntegration.start.z);
	exit(1);	
